...
})(this, function(__WEBPACK_EXTERNAL_MODULE_94__, __WEBPACK_EXTERNAL_MODULE_95__, __WEBPACK_EXTERNAL_MODULE_96__, __WEBPACK_EXTERNAL_MODULE_124__, __WEBPACK_EXTERNAL_MODULE_127__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lights = __webpack_require__(179);

	var _lights2 = _interopRequireDefault(_lights);

	var _cameras = __webpack_require__(184);

	var _cameras2 = _interopRequireDefault(_cameras);

	var _meshes = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Scene = __webpack_require__(138);

	var _Scene2 = _interopRequireDefault(_Scene);

	var _Material = __webpack_require__(147);
	...
	var _EntityLoaded = __webpack_require__(109);

	var _EntityLoaded2 = _interopRequireDefault(_EntityLoaded);

	var _Akkad = __webpack_require__(148);

	var _Akkad2 = _interopRequireDefault(_Akkad);

	var _BasicAnimation = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnimateMesh = __webpack_require__(112);
	...
	var _Rotate = __webpack_require__(125);

	var _Rotate2 = _interopRequireDefault(_Rotate);

	var _Wireframe = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RenderTrigger = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AkkadAbstractComponent = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classes = __webpack_require__(139);
	...
	var ShellComponent = function (_React$Component) {
	    (0, _inherits3.default)(ShellComponent, _React$Component);
	    ...
	    function ShellComponent() {
	        ...
	        (0, _classCallCheck3.default)(this, ShellComponent);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(ShellComponent)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this._setState = function (newState) {
	            console.log('hit _setState');
	            _this.setState(newState);
	        }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	    }

	    (0, _createClass3.default)(ShellComponent, [{
	        key: "componentWillMount",
	        value: function componentWillMount() {
	...
	ShellComponent.propTypes = {
	    internalSetState: _react.PropTypes.func
	};

	var Scene = function (_React$Component2) {
	    (0, _inherits3.default)(Scene, _React$Component2);

	    function Scene() {
	        (0, _classCallCheck3.default)(this, Scene);

	        var _this2 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Scene).call(this));

	        _this2.callAkkadRender = function () {
	            var appState = _this2.context.appState;
	            var children = _this2.props.children;

	            var hasScene = appState.hasIn(["entities", _this2.id]);
	            var passedContext = (0, _extends3.default)({
	                sceneID: _this2.id,
	                entityID: _this2.id
	            }, _this2.context);
	            if (hasScene) {
	                _this2.akkadRender.render(_react2.default.createElement(
	                    ShellComponent,
	                    null,
	                    children
	                ), passedContext);
	        ...
	        _this2.id = Math.floor((1 + Math.random()) * 10000000000).toString(16);
	        _this2.akkadRender = new _classes.AkkadRender();
	        return _this2;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MeshManager = __webpack_require__(140);

	var _MeshManager2 = _interopRequireDefault(_MeshManager);

	var _StateManager = __webpack_require__(141);
	...
	var _AkkadRender = __webpack_require__(142);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _is = __webpack_require__(143);
	...
	var _instantiateReactComponent = __webpack_require__(199);
	...
	var _ReactReconciler = __webpack_require__(219);

	var _ReactReconciler2 = _interopRequireDefault(_ReactReconciler);

	var _ReactDefaultInjection = __webpack_require__(250);
	    ...
	    (0, _createClass3.default)(AkkadRender, [{
	        ...
	        value: function render(newChildren, newContext) {
	            ...
	            if ((0, _is2.default)(this._mounted, false)) {
	                ...
	                var markup = _ReactReconciler2.default.mountComponent(wrapperInstance, transaction, null, ReactDOMContainerInfo(wrapperInstance), newContext);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actions2 = __webpack_require__(149);

	var _actions3 = _interopRequireDefault(_actions2);

	var _classes = __webpack_require__(139);

	var _PropsToContext = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appActions = __webpack_require__(150);

	var _appActions2 = _interopRequireDefault(_appActions);

	var _CameraActions = __webpack_require__(151);
	...
	var _ParticlesActions = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HemisphericLight = __webpack_require__(180);

	var _HemisphericLight2 = _interopRequireDefault(_HemisphericLight);

	var _PointLight = __webpack_require__(181);

	var _PointLight2 = _interopRequireDefault(_PointLight);

	var _SpotLight = __webpack_require__(182);

	var _SpotLight2 = _interopRequireDefault(_SpotLight);

	var _DirectionalLight = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FreeCamera = __webpack_require__(185);

	var _FreeCamera2 = _interopRequireDefault(_FreeCamera);

	var _ArcRotateCamera = __webpack_require__(186);

	var _ArcRotateCamera2 = _interopRequireDefault(_ArcRotateCamera);

	var _WebVRFreeCamera = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sphere = __webpack_require__(190);

	var _Sphere2 = _interopRequireDefault(_Sphere);

	var _Box = __webpack_require__(191);

	var _Box2 = _interopRequireDefault(_Box);

	var _Disc = __webpack_require__(192);

	var _Disc2 = _interopRequireDefault(_Disc);

	var _Ground = __webpack_require__(193);

	var _Ground2 = _interopRequireDefault(_Ground);

	var _GroundFromHeightMap = __webpack_require__(194);

	var _GroundFromHeightMap2 = _interopRequireDefault(_GroundFromHeightMap);

	var _Cylinder = __webpack_require__(195);

	var _Cylinder2 = _interopRequireDefault(_Cylinder);

	var _Torus = __webpack_require__(196);

	var _Torus2 = _interopRequireDefault(_Torus);

	var _Lines = __webpack_require__(197);

	var _Lines2 = _interopRequireDefault(_Lines);

	var _DashedLines = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactReconciler = __webpack_require__(219);
	var ReactUpdateQueue = __webpack_require__(222);

	var emptyObject = __webpack_require__(228);
	var invariant = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(233);
	var EventPluginHub = __webpack_require__(234);
	var EventPluginUtils = __webpack_require__(236);
	var ReactComponentEnvironment = __webpack_require__(202);
	var ReactClass = __webpack_require__(240);
	var ReactEmptyComponent = __webpack_require__(230);
	var ReactBrowserEventEmitter = __webpack_require__(244);
	var ReactNativeComponent = __webpack_require__(231);
	var ReactPerf = __webpack_require__(215);
	var ReactUpdates = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(237);
	var ReactErrorUtils = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = __webpack_require__(241);
	var ReactElement = __webpack_require__(205);
	var ReactPropTypeLocations = __webpack_require__(216);
	var ReactPropTypeLocationNames = __webpack_require__(218);
	var ReactNoopUpdateQueue = __webpack_require__(242);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isEventSupported = __webpack_require__(249);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMComponentTree = __webpack_require__(259);
	var ReactDOMEmptyComponent = __webpack_require__(314);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(237);
	var EventPropagators = __webpack_require__(252);
	var ExecutionEnvironment = __webpack_require__(248);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_assign(SyntheticEvent.prototype, {
	  ...
	  destructor: function () {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      var noop = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(233);
	var ReactDOMComponentFlags = __webpack_require__(260);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMChildrenOperations = __webpack_require__(270);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMLazyTree = __webpack_require__(271);
	var Danger = __webpack_require__(276);
	var ReactMultiChildUpdateTypes = __webpack_require__(280);
	var ReactPerf = __webpack_require__(215);

	var createMicrosoftUnsafeLocalFunction = __webpack_require__(272);
	var setInnerHTML = __webpack_require__(275);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(248);
	var escapeTextContentForBrowser = __webpack_require__(274);
	var setInnerHTML = __webpack_require__(275);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMLazyTree = __webpack_require__(271);
	var DOMNamespaces = __webpack_require__(293);
	var DOMProperty = __webpack_require__(233);
	...
	var validateDOMNesting = __webpack_require__(313);
	var warning = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(233);
	var ReactDOMInstrumentation = __webpack_require__(295);
	var ReactPerf = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMUnknownPropertyDevtool = __webpack_require__(297);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventListener = __webpack_require__(319);
	var ExecutionEnvironment = __webpack_require__(248);
	var PooledClass = __webpack_require__(225);
	var ReactDOMComponentTree = __webpack_require__(259);
	var ReactUpdates = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(207);
	var getEventCharCode = __webpack_require__(336);
	var invariant = __webpack_require__(203);
	var keyOf = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getEventCharCode = __webpack_require__(336);
	var getEventKey = __webpack_require__(337);
	var getEventModifierState = __webpack_require__(267);
